			...
			<form action="<?php echo $action; ?>" method="post">
				...
				<table class='table table-bordered'>
					...
					<tr>
						...
						<td><input type="text" class="form-control" name="id_karyawan" id="id_karyawan" placeholder="Id Karyawan" value="<?php echo $id_karyawan; ?>" /></td>
					</tr>
					...
					<tr>
						<td width='200'>Id Jenis <?php echo form_error('id_jenis') ?></td>
					...
					<tr>
						...
						<td><input type="text" class="form-control" name="validasi" id="validasi" placeholder="Validasi" value="<?php echo $validasi; ?>" /></td>
					</tr>
